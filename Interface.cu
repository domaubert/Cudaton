  ...
  if(even)
    {
      ...
      cudaMemcpy(buff,cubuff,NCELLX*NCELLY*sizeof(float)*4,cudaMemcpyDeviceToHost);
      //      if(neighbor[5]==6) printf("1005 spotted before siwthc");
      switchbuff(buff,neighbor[5],NCELLX*NCELLY*4);
      cudaMemcpy(cubuff,buff,NCELLX*NCELLY*sizeof(float)*4,cudaMemcpyHostToDevice);
      //      CUERR();
  ...
  else
    {
      ...
      cudaMemcpy(buff,cubuff,NCELLX*NCELLY*sizeof(float)*4,cudaMemcpyDeviceToHost);
      switchbuff(buff,neighbor[4],NCELLX*NCELLY*4);
      cudaMemcpy(cubuff,buff,NCELLX*NCELLY*sizeof(float)*4,cudaMemcpyHostToDevice);
  ...
  if(even)
    {
      ...
      cudaMemcpy(buff,cubuff,NCELLX*NCELLZ*sizeof(float)*4,cudaMemcpyDeviceToHost);
      switchbuff(buff,neighbor[3],NCELLX*NCELLZ*4);
      cudaMemcpy(cubuff,buff,NCELLX*NCELLZ*sizeof(float)*4,cudaMemcpyHostToDevice);
  ...
  else
    {
      ...
      cudaMemcpy(buff,cubuff,NCELLX*NCELLZ*sizeof(float)*4,cudaMemcpyDeviceToHost);
      switchbuff(buff,neighbor[2],NCELLX*NCELLZ*4);
      cudaMemcpy(cubuff,buff,NCELLX*NCELLZ*sizeof(float)*4,cudaMemcpyHostToDevice);
  ...
  if(even)
    {
      ...
      cudaMemcpy(buff,cubuff,NCELLY*NCELLZ*sizeof(float)*4,cudaMemcpyDeviceToHost);
      switchbuff(buff,neighbor[1],NCELLY*NCELLZ*4);
      cudaMemcpy(cubuff,buff,NCELLY*NCELLZ*sizeof(float)*4,cudaMemcpyHostToDevice);
  ...
  else
    {
      ...
      cudaMemcpy(buff,cubuff,NCELLY*NCELLZ*sizeof(float)*4,cudaMemcpyDeviceToHost);
      switchbuff(buff,neighbor[0],NCELLY*NCELLZ*4);
      cudaMemcpy(cubuff,buff,NCELLY*NCELLZ*sizeof(float)*4,cudaMemcpyHostToDevice);
