...
// Number of proc per dimension
  ...
  sscanf(hostname,"titane%04d",&hostnum); // getting the host numbers
...
#ifdef TITANE
  printf("Je suis processus %2d sur %2d avec ic_rank %d sur hote %s avec num %d\n",mpi_rank,mpi_size,ic_rank,hostname,hostnum); 
#endif
...
/*   // WRITE TEST */
/*   sprintf(fnt,"/scratch/cont003/teyssier/test/test_%05d_0_%05d",hostnum,mpi_rank); */
/*   ftest=fopen(fnt,"wb"); */
...
/* #ifdef TESTWRITE */
/*   // WRITE TEST */
/*   sprintf(fnt,"/scratch/cont003/teyssier/test/test_%05d_1_%05d",hostnum,mpi_rank); */
/*   ftest=fopen(fnt,"wb"); */
/*   fwrite(&dum,sizeof(int),1,ftest); */
/*   fclose(ftest); */
/* #endif */
...
/* #ifdef TESTWRITE */
/*   // WRITE TEST */
/*   sprintf(fnt,"/scratch/cont003/teyssier/test/test_%05d_2_%05d",hostnum,mpi_rank); */
/*   ftest=fopen(fnt,"wb"); */
/*   fwrite(&dum,sizeof(int),1,ftest); */
/*   fclose(ftest); */
/* #endif */
...
/*   // WRITE TEST */
/*   sprintf(fnt,"/scratch/cont003/teyssier/test/test_%05d_3_%05d",hostnum,mpi_rank); */
/*   ftest=fopen(fnt,"wb"); */
/*   fwrite(&dum,sizeof(int),1,ftest); */
/*   fclose(ftest); */
/*   if(mpi_rank==7) printf("mpirank=%d icrank=%d\n",mpi_rank,ic_rank); */
/* #endif */
  ...
  //if(verbose) puts("Initial Conditions ok");

/* #ifdef TESTWRITE */
/*   // WRITE TEST */
/*   sprintf(fnt,"/scratch/cont003/teyssier/test/test_%05d_4_%05d",hostnum,mpi_rank); */
/*   ftest=fopen(fnt,"wb"); */
/*   fwrite(&dum,sizeof(int),1,ftest); */
/*   fclose(ftest); */
/* #endif */
...
/* #ifdef TESTWRITE */
/*   sprintf(fnt,"/scratch/cont003/teyssier/test/test_%05d_5_%05d",hostnum,mpi_rank); */
/*   ftest=fopen(fnt,"wb"); */
/*   fwrite(&dum,sizeof(int),1,ftest); */
/*   fclose(ftest); */
/* #endif */
